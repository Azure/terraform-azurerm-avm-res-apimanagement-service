...
Description: Body-relative paths ignored on the policy fragment. Paths use dot notation.  
...
Description: AzAPI resource types and API versions used by the policy fragment submodule.

...
Description: Format of the policy content. Valid values: `xml`, `xml-link`, `rawxml`, `rawxml-link`.  
...
Description: Body-relative paths ignored on the policy resource. Paths use dot notation.  
...
Description: AzAPI resource types and API versions used by the policy submodule.

variable "parent_id" {
  type        = string
  description = "The fully-qualified ARM resource ID of the API that will contain this policy."
  nullable    = false
...
variable "ignore_body_changes" {
  ...
  default     = {}
  description = <<DESCRIPTION
Body-relative paths ignored on the API policy resource. Paths use dot notation.
Changes take effect only after apply. Ignored configuration is not sent to Azure.

- `apimanagement_service_apis_policies` - Paths ignored on the API policy resource.
DESCRIPTION
  nullable    = false
}
...
variable "resource_types" {
  ...
  default     = {}
  description = <<DESCRIPTION
AzAPI resource types and API versions used by the api_policy submodule.

- `apimanagement_service_apis_policies` - Resource type and API version for the API policy.
DESCRIPTION
  nullable    = false
}

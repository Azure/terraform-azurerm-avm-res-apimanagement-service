...
# terraform-azure-avm-res-apimanagement-service/api\_policy

Module to deploy `Microsoft.ApiManagement/service/apis/policies` using AzAPI.
...
Description: Body-relative paths ignored on the API policy resource. Paths use dot notation.  
...
Description: AzAPI resource types and API versions used by the api\_policy submodule.

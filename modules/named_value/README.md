...
Description: Body-relative paths ignored on the named value resource. Paths use dot notation.  
...
Description: AzAPI resource types and API versions used by the named\_value submodule.
...
### <a name="output_key_vault_last_status"></a> [key\_vault\_last\_status](#output\_key\_vault\_last\_status)
